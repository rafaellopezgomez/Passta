...
*/
Pr ([][0,900000000]((attrs != 2 || event != 3) || ((attrs == 2 && event == 3) U[0,300000000] attrs == 3)))
...
*/
Pr ([][0,900000000](event != 4 || ((attrs != 0 && attrs != 4 && event == 4) U[0,300000000] attrs == 4)))\
...
((attrs == 2 && event == 2) || (attrs == 4 && event == 4))\
)\
)\
)
...
((attrs == 3 && event == 3) || (attrs == 4 && event == 4))\
)\
)\
)
...
((attrs == 0 && event == 5) || (attrs == 5 && event == 4))\
)\
)\
)
